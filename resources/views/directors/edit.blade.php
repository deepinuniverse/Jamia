                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body p-4">
                        <form action="/directors/update" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 eng_sh">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="d_nm" name="d_name"  class="form-control" value="{{$director->name}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 eng_sh">
                                    <div class="form-group">
                                        <label for="name">{{ __("jamia.posi")}}</label>
                                        <input type="text" id="position" name="position"  class="form-control" value="{{$director->position}}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
