                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body p-4">
                        <form action="/customer_profit/update" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 eng_sh">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" required class="form-control" value="{{$profit->title}}">
                                    </div>
                                </div>
