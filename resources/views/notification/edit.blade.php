                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body p-4">
                        <form action="/notifications/update" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 eng_sh">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" >{{$notification->notes}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{ __("jamia.date")}}</label>
                                        <input type="date" id="cr_dt" value="{{$notification->created_dt}}" name="cr_dt" class="form-control">
                                        </div>
                                </div>
